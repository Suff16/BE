...
// Mendeteksi metode request HTTP (GET, POST, DELETE).
$method = $_SERVER['REQUEST_METHOD'];

// Menggunakan switch-case untuk menjalankan logika berdasarkan metode request.
switch ($method) {
    /**
     * Handle request GET.
     * Mengambil semua data atau satu data berdasarkan ID.
     */
    case 'GET':
    ...
    /**
     * Handle request POST.
     * Membuat data baru (INSERT) atau memperbarui data yang ada (UPDATE).
     */
    case 'POST':
